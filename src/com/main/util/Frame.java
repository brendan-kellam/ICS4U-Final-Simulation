...
public abstract class Frame {
	...
	public JSlider slider(int x, int y, int w, int h, int orientation, int min, int max, int initial){
		JSlider slider = new JSlider(orientation, min, max, initial);
		slider.setBounds(x, y, w, h);
		return slider;
	}
	
	public JCheckBox checkBox(int x, int y, int w, int h){
